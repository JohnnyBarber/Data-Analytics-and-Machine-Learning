...
$\\$
**The followings are sample mean, variance covariance matrix, and the sharpe ratio:**
$\\$
...
$\\$
**The following is the set of coeffcients (b's) for each factor.**
$\\$
$\\$
```{r}
b
...
$\\$
**The followings are the mean return, the standard deviation, and the Sharpe Ratio of the Mean Variance efficient porfolio:**
$\\$
